...
def get_feature_adaptor(embeddings, shrinking_factor=0.3, std_factor = 0.1, batch_size=32, num_workers=12, lr=0.001, epochs=12, use_cuda=True):
    ...
    target_size_of_weights = embeddings.shape[1] * target_length * 0.25 # lowered! # now it's 1! #0.5 # mean value of the weights should be 0.5
